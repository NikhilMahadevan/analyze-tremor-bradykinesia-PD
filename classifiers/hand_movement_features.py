'''
This file contains code to characterize hand movement. These features are used to characterize bradykinesia. The features
calculated are: 1. hand movement amplitude, 2. smoothness of hand movement (jerk measure)
'''
import pandas as pd
import numpy as np
...
def calculate_amplitude_and_smoothness_features(raw_accelerometer_data_df, fs):
    ...
    :param data_slice: DataFrame of raw accelerometer data
    :return:
    '''
    # Pre-process data
